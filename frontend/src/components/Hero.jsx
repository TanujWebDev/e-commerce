        ...
        <div className='w-full sm:w-1/2 flex items-center justify-center py-16 sm:py-0 px-8 sm:px-12 bg-zinc-50/30'>
         <div className='text-zinc-800 flex flex-col items-start'>
            ...
            <div className='flex items-center gap-2 mt-2 cursor-pointer'>
                <span className='font-semibold text-xs tracking-widest border border-zinc-300 px-6 py-3 rounded-md hover:bg-black hover:text-white hover:border-black transition-all duration-300'>
                  SHOP THE COLLECTION
                </span>
            </div>
         </div>
